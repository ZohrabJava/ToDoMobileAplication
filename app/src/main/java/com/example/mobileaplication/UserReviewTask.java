...
public class UserReviewTask extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_review_task);
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(UserReviewTask.this, LoginActivity.class));
            }
        });
        goBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(UserReviewTask.this, UserHomeActivity.class));
            }
        });
    }
        ...
        userApi.getTasksByUsernameAndStatus(HttpService.token, HttpService.username, 3L)
                .enqueue(new Callback<List<TaskDto>>() {
                    ...
                    public void onResponse(@NonNull Call<List<TaskDto>> call, @NonNull Response<List<TaskDto>> response) {
                        ...
                        for (TaskDto dto : taskDtoList) {
                            ...
                            button.setOnClickListener(v -> {
                                ...
                                startActivity(new Intent(UserReviewTask.this, UserReviewDetails.class));
                            });
                    ...
                    public void onFailure(@NonNull Call<List<TaskDto>> call, @NonNull Throwable t) {
                        Toast.makeText(UserReviewTask.this, "Page loading failed", Toast.LENGTH_SHORT).show();
