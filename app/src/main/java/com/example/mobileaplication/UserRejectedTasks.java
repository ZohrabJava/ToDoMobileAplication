...
public class UserRejectedTasks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_rejected_tasks);
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(UserRejectedTasks.this, LoginActivity.class));
            }
        });
        goBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(UserRejectedTasks.this, UserHomeActivity.class));
            }
        });
    }
    ...
    private void initializeComponents() {
        ...
        userApi.getTasksByUsernameAndStatus(HttpService.token, HttpService.username, 4L)
                .enqueue(new Callback<List<TaskDto>>() {
                    ...
                    public void onResponse(@NonNull Call<List<TaskDto>> call, @NonNull Response<List<TaskDto>> response) {
                        ...
                        for (TaskDto dto : taskDtoList) {
                            ...
                            button.setOnClickListener(v -> {
                                ...
                                startActivity(new Intent(UserRejectedTasks.this, UserRejectedTaskDetails.class));
                            });
                    ...
                    public void onFailure(@NonNull Call<List<TaskDto>> call, @NonNull Throwable t) {
                        Toast.makeText(UserRejectedTasks.this, "Page loading failed", Toast.LENGTH_SHORT).show();
