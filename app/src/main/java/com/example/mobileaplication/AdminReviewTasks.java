...
public class AdminReviewTasks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_review_tasks);
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(AdminReviewTasks.this, LoginActivity.class));
            }
        });
        goBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AdminReviewTasks.this, AdminHomeActivity.class));
            }
        });
    }
    ...
    private void initializeComponents() {
        ...
        userApi.getTasksByUsernameAndStatus(HttpService.token, HttpService.username, 3L)
                .enqueue(new Callback<List<TaskDto>>() {
                    ...
                    public void onResponse(@NonNull Call<List<TaskDto>> call, @NonNull Response<List<TaskDto>> response) {
                        ...
                        for (TaskDto dto : taskDtoList) {
                            ...
                            button.setOnClickListener(v -> {
                                ...
                                startActivity(new Intent(AdminReviewTasks.this, AdminReviewTaskDetails.class));
                            });
                    ...
                    public void onFailure(@NonNull Call<List<TaskDto>> call, @NonNull Throwable t) {
                        Toast.makeText(AdminReviewTasks.this, "Page loading failed", Toast.LENGTH_SHORT).show();
