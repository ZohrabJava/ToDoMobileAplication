...
public class AllTasks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(AllTasks.this, LoginActivity.class));
            }
        });
        goBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AllTasks.this, AdminHomeActivity.class));
            }
        });
    }
    ...
    private void initializeComponents() {
        ...
        userApi.getAllTask(HttpService.token)
                .enqueue(new Callback<List<TaskDto>>() {
                    ...
                    public void onResponse(@NonNull Call<List<TaskDto>> call, @NonNull Response<List<TaskDto>> response) {
                        ...
                        for (TaskDto dto : taskDtoList) {
                            ...
                            button.setOnClickListener(v -> {
                                ...
                                startActivity(new Intent(AllTasks.this, AllTaskDetails.class));
                            });
                    ...
                    public void onFailure(@NonNull Call<List<TaskDto>> call, @NonNull Throwable t) {
                        Toast.makeText(AllTasks.this, "Page loading failed", Toast.LENGTH_SHORT).show();
