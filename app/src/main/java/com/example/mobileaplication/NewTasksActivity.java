...
public class NewTasksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(NewTasksActivity.this, LoginActivity.class));
            }
        });
        goBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(NewTasksActivity.this, UserHomeActivity.class));
            }
        });
    }
    ...
    private void initializeComponents() {
        ...
        userApi.getTasksByUsernameAndStatus(HttpService.token, HttpService.username, 1L)
                .enqueue(new Callback<List<TaskDto>>() {
                    ...
                    public void onResponse(@NonNull Call<List<TaskDto>> call, @NonNull Response<List<TaskDto>> response) {
                        ...
                        for (TaskDto dto : taskDtoList) {
                            ...
                            button.setOnClickListener(v -> {
                                ...
                                startActivity(new Intent(NewTasksActivity.this, NewTaskDetails.class));
                            });
                    ...
                    public void onFailure(@NonNull Call<List<TaskDto>> call, @NonNull Throwable t) {
                        Toast.makeText(NewTasksActivity.this, "Page loading failed", Toast.LENGTH_SHORT).show();
